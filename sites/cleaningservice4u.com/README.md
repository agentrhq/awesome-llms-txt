---
domain: cleaningservice4u.com
display_name: Detailed Content
category: dev-tools
score: 46
grade: D
last_scored: 2026-05-27
verified_url: https://cleaningservice4u.com/llms.txt
file_size_bytes: 16774
link_count: 0
value_link_count: 0
section_count: 2
...
**File facts:** 16.4 KB · 2 `## sections` · 0 links (0 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
```bash
npx llms-txt-score https://cleaningservice4u.com/llms.txt
```
