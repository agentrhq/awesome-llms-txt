...
verified_url: https://www.maersk.com/llms.txt
file_size_bytes: 7284
link_count: 54
value_link_count: 42
section_count: 0
...
![Score 48/100 — Grade D](../../web/badge/www.maersk.com.svg)
...
**H1:** llms.txt - the new Pascal's Wager


**File facts:** 7.1 KB · 0 `## sections` · 54 links (42 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 48 (D)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/www.maersk.com.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/www.maersk.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.maersk.com/llms.txt
```
