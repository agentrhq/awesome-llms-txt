---
domain: daisyui.com
display_name: daisyUI 5
category: dev-tools
score: 45
grade: D
last_scored: 2026-05-27
verified_url: https://daisyui.com/llms.txt
file_size_bytes: 63204
link_count: 4
value_link_count: 4
section_count: 5
...
**File facts:** 61.7 KB · 5 `## sections` · 4 links (4 after low-value discount) · Freshness: 5 days (per `Last-Modified`).
...
```bash
npx llms-txt-score https://daisyui.com/llms.txt
```
