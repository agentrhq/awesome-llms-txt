---
domain: razor-press.web-templates.io
display_name: Razor Press
category: dev-tools
score: 60
grade: C
last_scored: 2026-05-27
verified_url: https://razor-press.web-templates.io/llms.txt
file_size_bytes: 4359
link_count: 30
value_link_count: 30
section_count: 1
...
![Score 60/100 — Grade C](../../web/badge/razor-press.web-templates.io.svg)
...
**File facts:** 4.3 KB · 1 `## sections` · 30 links (30 after low-value discount) · Freshness: 169 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 60 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/razor-press.web-templates.io.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/razor-press.web-templates.io)
```

## Reproduce this score

```bash
npx llms-txt-score https://razor-press.web-templates.io/llms.txt
```
