---
domain: docs.zep.us
display_name: ZEP Guidebook (EN)
category: dev-tools
score: 58
grade: C
last_scored: 2026-05-27
verified_url: https://docs.zep.us/llms.txt
file_size_bytes: 6825
link_count: 55
value_link_count: 55
section_count: 1
...
**File facts:** 6.7 KB · 1 `## sections` · 55 links (55 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.zep.us/llms.txt
```
