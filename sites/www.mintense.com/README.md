---
domain: www.mintense.com
display_name: Mintense
category: dev-tools
score: 35
grade: D
last_scored: 2026-05-27
verified_url: https://www.mintense.com/llms.txt
file_size_bytes: 732
link_count: 0
value_link_count: 0
section_count: 0
...
![Score 35/100 — Grade D](../../web/badge/www.mintense.com.svg)
...
**H1:** llms.txt - Guidelines for Large Language Models (LLMs)
...
|---|---:|---|
| Spec compliance | 4/18 | _multi_h1_7, no_blockquote_summary, no_structure_ |
...
- Spec compliance (4/18): multi_h1_7, no_blockquote_summary, no_structure
...
```markdown
[![llms.txt score 35 (D)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/www.mintense.com.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/www.mintense.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.mintense.com/llms.txt
```
