---
domain: docs.getomni.ai
display_name: OmniAI Docs
category: dev-tools
score: 63
grade: C
last_scored: 2026-05-27
verified_url: https://docs.getomni.ai/llms.txt
file_size_bytes: 4478
link_count: 46
value_link_count: 39
section_count: 1
...
**File facts:** 4.4 KB · 1 `## sections` · 46 links (39 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
```bash
npx llms-txt-score https://docs.getomni.ai/llms.txt
```
