---
domain: docs.parallel.ai
display_name: Parallel
category: ai-platform
score: 78
grade: B+
last_scored: 2026-05-27
verified_url: https://docs.parallel.ai/llms.txt
file_size_bytes: 20141
link_count: 141
...
![Score 78/100 — Grade B+](../../web/badge/docs.parallel.ai.svg)
...
**File facts:** 19.7 KB · 3 `## sections` · 141 links (141 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 78 (B+)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/docs.parallel.ai.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.parallel.ai)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.parallel.ai/llms.txt
```
