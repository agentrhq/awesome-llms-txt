---
domain: www.drbucky.com
display_name: Drbucky
category: dev-tools
score: 44
grade: D
last_scored: 2026-05-27
verified_url: https://www.drbucky.com/llms.txt
file_size_bytes: 7336
link_count: 50
value_link_count: 46
section_count: 0
freshness_age_days: 414
---

# Drbucky

![Score 44/100 — Grade D](../../web/badge/www.drbucky.com.svg)
...
**H1:** https://www.drbucky.com llms.txt


**File facts:** 7.2 KB · 0 `## sections` · 50 links (46 after low-value discount) · Freshness: 414 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 44 (D)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/www.drbucky.com.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/www.drbucky.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.drbucky.com/llms.txt
```
