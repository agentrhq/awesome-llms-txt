...
verified_url: https://novilabs.com/llms.txt
file_size_bytes: 678583
link_count: 0
value_link_count: 0
section_count: 14
...
**File facts:** 662.7 KB · 14 `## sections` · 0 links (0 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
| Size discipline | 0/6 | _oversized_663kb_ |
...
- Size discipline (0/6): oversized_663kb
...
```bash
npx llms-txt-score https://novilabs.com/llms.txt
```
