---
domain: docs.latch.io
display_name: Latch Docs
category: dev-tools
score: 54
grade: C
last_scored: 2026-05-27
verified_url: https://docs.latch.io/llms.txt
file_size_bytes: 2124
link_count: 15
value_link_count: 13
section_count: 1
...
**File facts:** 2.1 KB · 1 `## sections` · 15 links (13 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.latch.io/llms.txt
```
