...
display_name: Pydantic Validation (Latest)
category: dev-tools
score: 68
grade: B
last_scored: 2026-05-27
verified_url: https://pydantic.dev/docs/validation/latest/llms.txt
file_size_bytes: 9555
link_count: 88
value_link_count: 88
section_count: 8
...
![Score 68/100 — Grade B](../../web/badge/docs.pydantic.dev.svg)
...
**H1:** Pydantic Validation (Latest)

> Data validation using Python type hints

**File facts:** 9.3 KB · 8 `## sections` · 88 links (88 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 68 (B)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/docs.pydantic.dev.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.pydantic.dev)
```

## Reproduce this score

```bash
npx llms-txt-score https://pydantic.dev/docs/validation/latest/llms.txt
```
