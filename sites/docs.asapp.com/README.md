---
domain: docs.asapp.com
display_name: ASAPP Docs
category: dev-tools
score: 75
grade: B+
last_scored: 2026-05-27
verified_url: https://docs.asapp.com/llms.txt
file_size_bytes: 40634
link_count: 265
...
**File facts:** 39.7 KB · 2 `## sections` · 265 links (265 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
```bash
npx llms-txt-score https://docs.asapp.com/llms.txt
```
