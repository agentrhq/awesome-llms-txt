...
verified_url: https://docs.vooi.io/llms.txt
file_size_bytes: 4901
link_count: 36
value_link_count: 36
section_count: 1
...
**File facts:** 4.8 KB · 1 `## sections` · 36 links (36 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.vooi.io/llms.txt
```
