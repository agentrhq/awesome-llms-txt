---
domain: www.customtentswithlogo.com
display_name: Default Store View
category: dev-tools
score: 57
grade: C
last_scored: 2026-05-27
verified_url: https://www.customtentswithlogo.com/llms.txt
file_size_bytes: 237817
link_count: 972
value_link_count: 972
section_count: 2
...
**File facts:** 232.2 KB · 2 `## sections` · 972 links (972 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://www.customtentswithlogo.com/llms.txt
```
