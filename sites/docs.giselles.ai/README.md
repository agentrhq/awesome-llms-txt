---
domain: docs.giselles.ai
display_name: Docs
category: dev-tools
score: 45
grade: D
last_scored: 2026-05-27
verified_url: https://docs.giselles.ai/en/llms.txt
file_size_bytes: 9072
link_count: 60
value_link_count: 60
section_count: 0
...
![Score 45/100 — Grade D](../../web/badge/docs.giselles.ai.svg)
...
**File facts:** 8.9 KB · 0 `## sections` · 60 links (60 after low-value discount) · Freshness: unknown (no `Last-Modified` header).

## Scorecard

| Criterion | Score | Notes |
|---|---:|---|
| Spec compliance | 10/18 | _no_blockquote_summary, malformed_link_items_ |
...
```markdown
[![llms.txt score 45 (D)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/docs.giselles.ai.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.giselles.ai)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.giselles.ai/en/llms.txt
```
