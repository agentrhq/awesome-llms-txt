---
domain: www.captivaterecipes.com
display_name: Captivaterecipes
category: dev-tools
score: 27
grade: F
last_scored: 2026-05-27
verified_url: https://captivaterecipes.com/llms.txt
file_size_bytes: 51459
link_count: 0
value_link_count: 0
section_count: 0
...
![Score 27/100 — Grade F](../../web/badge/www.captivaterecipes.com.svg)
...
**File facts:** 50.3 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 27 (F)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/www.captivaterecipes.com.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/www.captivaterecipes.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://captivaterecipes.com/llms.txt
```
