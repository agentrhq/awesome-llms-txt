...
verified_url: https://console.groq.com/llms.txt
file_size_bytes: 63244
link_count: 150
value_link_count: 150
section_count: 0
...
![Score 54/100 — Grade C](../../web/badge/console.groq.com.svg)
...
**H1:** https://console.groq.com llms.txt


**File facts:** 61.8 KB · 0 `## sections` · 150 links (150 after low-value discount) · Freshness: 1 day (per `Last-Modified`).
...
```markdown
[![llms.txt score 54 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/console.groq.com.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/console.groq.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://console.groq.com/llms.txt
```
