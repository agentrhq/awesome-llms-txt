...
verified_url: https://docs.carv.io/llms.txt
file_size_bytes: 11980
link_count: 100
...
**File facts:** 11.7 KB · 1 `## sections` · 100 links (100 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.carv.io/llms.txt
```
