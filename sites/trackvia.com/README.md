...
verified_url: https://trackvia.com/llms.txt
file_size_bytes: 772
link_count: 11
value_link_count: 11
section_count: 3
...
![Score 48/100 — Grade D](../../web/badge/trackvia.com.svg)
...
**File facts:** 0.8 KB · 3 `## sections` · 11 links (11 after low-value discount) · Freshness: 420 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 48 (D)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/trackvia.com.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/trackvia.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://trackvia.com/llms.txt
```
