...
verified_url: https://turso.tech/llms.txt
file_size_bytes: 11125
link_count: 0
value_link_count: 0
section_count: 10
...
![Score 57/100 — Grade C](../../web/badge/turso.tech.svg)
...
**File facts:** 10.9 KB · 10 `## sections` · 0 links (0 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 57 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/turso.tech.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/turso.tech)
```

## Reproduce this score

```bash
npx llms-txt-score https://turso.tech/llms.txt
```
