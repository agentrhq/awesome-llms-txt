---
domain: simplepdf.com
display_name: Simplepdf
category: dev-tools
score: 35
grade: D
last_scored: 2026-05-27
verified_url: https://simplepdf.com/llms.txt
file_size_bytes: 20651
link_count: 0
value_link_count: 0
section_count: 0
...
**File facts:** 20.2 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 1 day (per `Last-Modified`).
...
```bash
npx llms-txt-score https://simplepdf.com/llms.txt
```
