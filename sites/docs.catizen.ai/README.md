---
domain: docs.catizen.ai
display_name: Catizen Docs
category: dev-tools
score: 57
grade: C
last_scored: 2026-05-27
verified_url: https://docs.catizen.ai/llms.txt
file_size_bytes: 2942
link_count: 28
value_link_count: 28
section_count: 3
...
![Score 57/100 — Grade C](../../web/badge/docs.catizen.ai.svg)
...
**H1:** Catizen Whitepaper V0.2.2


**File facts:** 2.9 KB · 3 `## sections` · 28 links (28 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 57 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/docs.catizen.ai.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.catizen.ai)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.catizen.ai/llms.txt
```
