---
domain: maplebridge.io
display_name: Maplebridge
category: dev-tools
score: 35
grade: D
last_scored: 2026-05-27
verified_url: https://maplebridge.io/llms.txt
file_size_bytes: 13659
link_count: 0
value_link_count: 0
section_count: 0
...
![Score 35/100 — Grade D](../../web/badge/maplebridge.io.svg)
...
**File facts:** 13.3 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 2 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 35 (D)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/maplebridge.io.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/maplebridge.io)
```

## Reproduce this score

```bash
npx llms-txt-score https://maplebridge.io/llms.txt
```
