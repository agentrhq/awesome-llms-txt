...
verified_url: https://sgnl.ai/llms.txt
file_size_bytes: 5527
link_count: 24
value_link_count: 22
section_count: 5
...
![Score 57/100 — Grade C](../../web/badge/sgnl.ai.svg)
...
**File facts:** 5.4 KB · 5 `## sections` · 24 links (22 after low-value discount) · Freshness: 32 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 57 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/sgnl.ai.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/sgnl.ai)
```

## Reproduce this score

```bash
npx llms-txt-score https://sgnl.ai/llms.txt
```
