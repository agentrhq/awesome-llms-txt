---
domain: docs.usebraintrust.com
display_name: Braintrust Community
category: dev-tools
score: 54
grade: C
last_scored: 2026-05-27
verified_url: https://docs.usebraintrust.com/communitydocs/llms.txt
file_size_bytes: 6771
link_count: 30
value_link_count: 30
section_count: 1
...
**H1:** Braintrust Community


**File facts:** 6.6 KB · 1 `## sections` · 30 links (30 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.usebraintrust.com/communitydocs/llms.txt
```
