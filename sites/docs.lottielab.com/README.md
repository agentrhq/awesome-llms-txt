---
domain: docs.lottielab.com
display_name: Lottielab Docs
category: dev-tools
score: 58
grade: C
last_scored: 2026-05-27
verified_url: https://docs.lottielab.com/llms.txt
file_size_bytes: 14261
link_count: 127
...
**File facts:** 13.9 KB · 1 `## sections` · 127 links (127 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.lottielab.com/llms.txt
```
