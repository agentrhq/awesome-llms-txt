---
domain: docs.circular.bot
display_name: Circular Docs
category: dev-tools
score: 56
grade: C
last_scored: 2026-05-27
verified_url: https://docs.circular.bot/circular-docs/llms.txt
file_size_bytes: 3001
link_count: 29
value_link_count: 29
section_count: 1
...
![Score 56/100 — Grade C](../../web/badge/docs.circular.bot.svg)
...
**File facts:** 2.9 KB · 1 `## sections` · 29 links (29 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 56 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/docs.circular.bot.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.circular.bot)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.circular.bot/circular-docs/llms.txt
```
