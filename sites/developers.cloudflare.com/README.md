...
display_name: Cloudflare Developers
category: infra
score: 62
grade: C
last_scored: 2026-05-27
verified_url: https://developers.cloudflare.com/llms.txt
...
![Score 62/100 — Grade C](../../web/badge/developers.cloudflare.com.svg)
...
**File facts:** 15.0 KB · 9 `## sections` · 103 links (103 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 62 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/developers.cloudflare.com.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/developers.cloudflare.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://developers.cloudflare.com/llms.txt
```
