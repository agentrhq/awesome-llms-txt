---
domain: docs.chirpwireless.io
display_name: Chirp Platform
category: dev-tools
score: 60
grade: C
last_scored: 2026-05-27
verified_url: https://docs.chirpwireless.io/llms.txt
file_size_bytes: 11617
link_count: 120
value_link_count: 120
section_count: 1
...
**File facts:** 11.3 KB · 1 `## sections` · 120 links (120 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.chirpwireless.io/llms.txt
```
