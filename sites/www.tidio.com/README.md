---
domain: www.tidio.com
display_name: Tidio
category: dev-tools
score: 35
grade: D
last_scored: 2026-05-27
verified_url: https://www.tidio.com/llms.txt
file_size_bytes: 13124
link_count: 0
value_link_count: 0
section_count: 0
...
![Score 35/100 — Grade D](../../web/badge/www.tidio.com.svg)
...
**File facts:** 12.8 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 5 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 35 (D)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/www.tidio.com.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/www.tidio.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.tidio.com/llms.txt
```
