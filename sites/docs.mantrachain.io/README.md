...
```markdown
[![llms.txt score 59 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/docs/badge/docs.mantrachain.io.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.mantrachain.io)
```
