...
![Score 78/100 — Grade B+](../../web/badge/nitro.build.svg)
...
**File facts:** 9.7 KB · 2 `## sections` · 83 links (82 after low-value discount) · Freshness: 3 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 78 (B+)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/nitro.build.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/nitro.build)
```

## Reproduce this score

```bash
npx llms-txt-score https://nitro.build/llms.txt
```
