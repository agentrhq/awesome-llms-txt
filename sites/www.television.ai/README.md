---
domain: www.television.ai
display_name: Name
category: billing
score: 39
grade: D
last_scored: 2026-05-27
verified_url: https://www.television.ai/llms.txt
file_size_bytes: 1637
link_count: 0
value_link_count: 0
section_count: 0
...
**File facts:** 1.6 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 0 days (per `Last-Modified`).

## Scorecard

| Criterion | Score | Notes |
|---|---:|---|
| Spec compliance | 4/18 | _multi_h1_12, no_blockquote_summary, no_structure, malformed_link_items_ |
...
- Spec compliance (4/18): multi_h1_12, no_blockquote_summary, no_structure
...
```bash
npx llms-txt-score https://www.television.ai/llms.txt
```
