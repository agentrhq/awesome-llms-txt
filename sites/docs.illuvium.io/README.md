---
domain: docs.illuvium.io
display_name: Illuvium Staking Docs
category: dev-tools
score: 54
grade: C
last_scored: 2026-05-27
verified_url: https://docs.illuvium.io/staking-v2/llms.txt
file_size_bytes: 3863
link_count: 27
value_link_count: 27
section_count: 1
...
**H1:** Illuvium Staking Docs


**File facts:** 3.8 KB · 1 `## sections` · 27 links (27 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.illuvium.io/staking-v2/llms.txt
```
