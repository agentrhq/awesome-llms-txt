---
domain: docs.wonderchat.io
display_name: Wonderchat Documentation
category: dev-tools
score: 58
grade: C
last_scored: 2026-05-27
verified_url: https://docs.wonderchat.io/llms.txt
file_size_bytes: 18827
link_count: 109
...
**H1:** Wonderchat Documentation


**File facts:** 18.4 KB · 1 `## sections` · 109 links (109 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.wonderchat.io/llms.txt
```
