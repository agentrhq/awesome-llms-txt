---
domain: www.superskills.co.uk
display_name: Website Information
category: dev-tools
score: 31
grade: F
last_scored: 2026-05-27
verified_url: https://www.superskills.co.uk/llms.txt
file_size_bytes: 8187
link_count: 0
value_link_count: 0
section_count: 0
...
**H1:** Website Information


**File facts:** 8.0 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 474 days (per `Last-Modified`).

## Scorecard

| Criterion | Score | Notes |
|---|---:|---|
| Spec compliance | 4/18 | _multi_h1_5, no_blockquote_summary, no_structure, malformed_link_items_ |
...
- Spec compliance (4/18): multi_h1_5, no_blockquote_summary, no_structure
...
```bash
npx llms-txt-score https://www.superskills.co.uk/llms.txt
```
