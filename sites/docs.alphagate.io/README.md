---
domain: docs.alphagate.io
display_name: Alphagate Docs
category: dev-tools
score: 56
grade: C
last_scored: 2026-05-27
verified_url: https://docs.alphagate.io/llms.txt
file_size_bytes: 2078
link_count: 19
value_link_count: 19
section_count: 1
...
![Score 56/100 — Grade C](../../web/badge/docs.alphagate.io.svg)
...
**File facts:** 2.0 KB · 1 `## sections` · 19 links (19 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 56 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/docs.alphagate.io.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.alphagate.io)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.alphagate.io/llms.txt
```
