---
domain: therapydave.com
display_name: Therapydave
category: dev-tools
score: 47
grade: D
last_scored: 2026-05-27
verified_url: https://therapydave.com/llms.txt
file_size_bytes: 16231
link_count: 0
value_link_count: 0
section_count: 18
...
**H1:** TherapyDave llms.txt


**File facts:** 15.9 KB · 18 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://therapydave.com/llms.txt
```
