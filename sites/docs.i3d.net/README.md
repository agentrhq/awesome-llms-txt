---
domain: docs.i3d.net
display_name: I3d Docs
category: dev-tools
score: 62
grade: C
last_scored: 2026-05-27
verified_url: https://docs.i3d.net/llms.txt
file_size_bytes: 28379
link_count: 328
value_link_count: 328
section_count: 1
...
![Score 62/100 — Grade C](../../web/badge/docs.i3d.net.svg)
...
**H1:** i3D.net Documentation


**File facts:** 27.7 KB · 1 `## sections` · 328 links (328 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 62 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/docs.i3d.net.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.i3d.net)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.i3d.net/llms.txt
```
