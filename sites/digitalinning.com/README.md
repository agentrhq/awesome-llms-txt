---
domain: digitalinning.com
display_name: Digitalinning
category: dev-tools
score: 27
grade: F
last_scored: 2026-05-27
verified_url: https://digitalinning.com/llms.txt
file_size_bytes: 24104
link_count: 0
value_link_count: 0
section_count: 0
freshness_age_days: 253
---

# Digitalinning

![Score 27/100 — Grade F](../../web/badge/digitalinning.com.svg)
...
**File facts:** 23.5 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 253 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 27 (F)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/digitalinning.com.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/digitalinning.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://digitalinning.com/llms.txt
```
