---
domain: www.fervenza.fr
display_name: Fervenza
category: dev-tools
score: 51
grade: C
last_scored: 2026-05-27
verified_url: https://www.fervenza.fr/llms.txt
file_size_bytes: 4504
link_count: 29
value_link_count: 29
section_count: 0
...
![Score 51/100 — Grade C](../../web/badge/www.fervenza.fr.svg)
...
**H1:** https://www.fervenza.fr llms.txt


**File facts:** 4.4 KB · 0 `## sections` · 29 links (29 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 51 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/www.fervenza.fr.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/www.fervenza.fr)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.fervenza.fr/llms.txt
```
