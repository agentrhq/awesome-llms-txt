---
domain: docs.journify.io
display_name: Journify Docs
category: dev-tools
score: 57
grade: C
last_scored: 2026-05-27
verified_url: https://docs.journify.io/llms.txt
file_size_bytes: 16659
link_count: 134
...
**File facts:** 16.3 KB · 1 `## sections` · 134 links (134 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.journify.io/llms.txt
```
