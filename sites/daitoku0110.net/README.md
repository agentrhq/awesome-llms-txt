---
domain: daitoku0110.net
display_name: Detailed Content
category: dev-tools
score: 39
grade: D
last_scored: 2026-05-27
verified_url: https://daitoku0110.net/llms.txt
file_size_bytes: 1047
link_count: 0
value_link_count: 0
section_count: 2
...
**File facts:** 1.0 KB · 2 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://daitoku0110.net/llms.txt
```
