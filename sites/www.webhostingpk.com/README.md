---
domain: www.webhostingpk.com
display_name: Detailed Content
category: dev-tools
score: 39
grade: D
last_scored: 2026-05-27
verified_url: https://www.webhostingpk.com/llms.txt
file_size_bytes: 61208
link_count: 0
value_link_count: 0
section_count: 3
...
**File facts:** 59.8 KB · 3 `## sections` · 0 links (0 after low-value discount) · Freshness: 58 days (per `Last-Modified`).
...
```bash
npx llms-txt-score https://www.webhostingpk.com/llms.txt
```
