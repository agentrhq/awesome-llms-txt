---
domain: www.sedigital.es
display_name: SEDIGITAL, SEO AGENCY IN MADRID
category: dev-tools
score: 48
grade: D
last_scored: 2026-05-27
verified_url: https://www.sedigital.es/llms.txt
file_size_bytes: 9462
link_count: 7
value_link_count: 7
section_count: 4
freshness_age_days: 453
---

# SEDIGITAL, SEO AGENCY IN MADRID

![Score 48/100 — Grade D](../../web/badge/www.sedigital.es.svg)
...
**H1:** SEDIGITAL, SEO AGENCY IN MADRID
...
**File facts:** 9.2 KB · 4 `## sections` · 7 links (7 after low-value discount) · Freshness: 453 days (per `Last-Modified`).
...
| Freshness | 1/10 | _stale_454_days_ |
| Discoverability | 8/8 | |
...
- Freshness (1/10): stale_454_days
- Auth signposting (0/8): no_auth_keywords, no_auth_section

## Embed the badge

```markdown
[![llms.txt score 48 (D)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/www.sedigital.es.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/www.sedigital.es)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.sedigital.es/llms.txt
```
