---
domain: use-fireproof.com
display_name: Fireproof Database API
category: data
score: 45
grade: D
last_scored: 2026-05-27
verified_url: https://use-fireproof.com/llms.txt
file_size_bytes: 5603
link_count: 0
value_link_count: 0
section_count: 6
...
**H1:** Fireproof Database API


**File facts:** 5.5 KB · 6 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://use-fireproof.com/llms.txt
```
