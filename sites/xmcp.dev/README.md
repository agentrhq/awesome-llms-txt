...
verified_url: https://xmcp.dev/llms.txt
file_size_bytes: 5795
link_count: 37
value_link_count: 37
section_count: 10
...
![Score 72/100 — Grade B](../../web/badge/xmcp.dev.svg)
...
**File facts:** 5.7 KB · 10 `## sections` · 37 links (37 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 72 (B)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/xmcp.dev.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/xmcp.dev)
```

## Reproduce this score

```bash
npx llms-txt-score https://xmcp.dev/llms.txt
```
