---
domain: www.assurance-voiture-temporaire-provisoire.com
display_name: Assurance Voiture Temporaire Provisoire
category: dev-tools
score: 26
grade: F
last_scored: 2026-05-27
verified_url: https://www.assurance-voiture-temporaire-provisoire.com/llms.txt
file_size_bytes: 399070
link_count: 0
value_link_count: 0
section_count: 0
...
![Score 26/100 — Grade F](../../web/badge/www.assurance-voiture-temporaire-provisoire.com.svg)
...
**File facts:** 389.7 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
| Size discipline | 1/6 | _oversized_390kb_ |
...
- Size discipline (1/6): oversized_390kb

## Embed the badge

```markdown
[![llms.txt score 26 (F)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/www.assurance-voiture-temporaire-provisoire.com.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/www.assurance-voiture-temporaire-provisoire.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.assurance-voiture-temporaire-provisoire.com/llms.txt
```
