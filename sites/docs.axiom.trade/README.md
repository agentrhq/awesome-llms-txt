---
domain: docs.axiom.trade
display_name: Axiom
category: dev-tools
score: 55
grade: C
last_scored: 2026-05-27
verified_url: https://docs.axiom.trade/llms.txt
file_size_bytes: 3468
link_count: 34
value_link_count: 34
section_count: 1
...
**File facts:** 3.4 KB · 1 `## sections` · 34 links (34 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.axiom.trade/llms.txt
```
