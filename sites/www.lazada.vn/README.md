...
verified_url: https://www.lazada.vn/llms.txt
...
**H1:** Lazada Việt Nam (lazada.vn)


**File facts:** 3.6 KB · 4 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://www.lazada.vn/llms.txt
```
