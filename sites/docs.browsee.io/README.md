---
domain: docs.browsee.io
display_name: Browsee
category: dev-tools
score: 56
grade: C
last_scored: 2026-05-27
verified_url: https://docs.browsee.io/llms.txt
file_size_bytes: 10429
link_count: 73
value_link_count: 73
section_count: 1
...
**File facts:** 10.2 KB · 1 `## sections` · 73 links (73 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.browsee.io/llms.txt
```
