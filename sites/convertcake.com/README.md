...
verified_url: https://convertcake.com/llms.txt
file_size_bytes: 1132879
link_count: 0
value_link_count: 0
section_count: 5
...
**File facts:** 1106.3 KB · 5 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
| Size discipline | 0/6 | _oversized_1106kb_ |
...
- Size discipline (0/6): oversized_1106kb
...
```bash
npx llms-txt-score https://convertcake.com/llms.txt
```
