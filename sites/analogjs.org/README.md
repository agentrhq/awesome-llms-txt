...
verified_url: https://analogjs.org/llms.txt
file_size_bytes: 6773
link_count: 35
value_link_count: 35
section_count: 1
...
![Score 59/100 — Grade C](../../web/badge/analogjs.org.svg)
...
**File facts:** 6.6 KB · 1 `## sections` · 35 links (35 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 59 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/analogjs.org.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/analogjs.org)
```

## Reproduce this score

```bash
npx llms-txt-score https://analogjs.org/llms.txt
```
