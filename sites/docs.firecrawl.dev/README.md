...
display_name: Firecrawl Docs
category: dev-tools
score: 75
grade: B+
last_scored: 2026-05-27
verified_url: https://docs.firecrawl.dev/llms.txt
file_size_bytes: 20032
link_count: 157
value_link_count: 151
section_count: 3
...
**File facts:** 19.6 KB · 3 `## sections` · 157 links (151 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
```bash
npx llms-txt-score https://docs.firecrawl.dev/llms.txt
```
