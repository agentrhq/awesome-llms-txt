...
verified_url: https://docs.e6data.com/product-documentation/llms.txt
file_size_bytes: 47062
link_count: 271
value_link_count: 271
section_count: 1
...
![Score 59/100 — Grade C](../../web/badge/docs.e6data.com.svg)
...
**File facts:** 46.0 KB · 1 `## sections` · 271 links (271 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 59 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/docs.e6data.com.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.e6data.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.e6data.com/product-documentation/llms.txt
```
