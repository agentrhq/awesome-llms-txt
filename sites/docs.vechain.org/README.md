---
domain: docs.vechain.org
display_name: VeChain Docs
category: dev-tools
score: 59
grade: C
last_scored: 2026-05-27
verified_url: https://docs.vechain.org/llms.txt
file_size_bytes: 27643
link_count: 196
value_link_count: 196
section_count: 1
...
![Score 59/100 — Grade C](../../web/badge/docs.vechain.org.svg)
...
**File facts:** 27.0 KB · 1 `## sections` · 196 links (196 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 59 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/docs.vechain.org.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.vechain.org)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.vechain.org/llms.txt
```
