---
domain: docs.ice.io
display_name: Ice Open Network
category: dev-tools
score: 55
grade: C
last_scored: 2026-05-27
verified_url: https://docs.ice.io/llms.txt
file_size_bytes: 2756
link_count: 29
value_link_count: 28
section_count: 1
...
![Score 55/100 — Grade C](../../web/badge/docs.ice.io.svg)
...
**File facts:** 2.7 KB · 1 `## sections` · 29 links (28 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 55 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/docs.ice.io.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.ice.io)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.ice.io/llms.txt
```
