...
verified_url: https://boehs.org/llms.txt
file_size_bytes: 789
link_count: 0
value_link_count: 0
section_count: 0
...
![Score 37/100 — Grade D](../../web/badge/boehs.org.svg)
...
**File facts:** 0.8 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 37 (D)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/boehs.org.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/boehs.org)
```

## Reproduce this score

```bash
npx llms-txt-score https://boehs.org/llms.txt
```
