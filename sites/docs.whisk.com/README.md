---
domain: docs.whisk.com
display_name: Whisk Docs
category: dev-tools
score: 63
grade: C
last_scored: 2026-05-27
verified_url: https://docs.whisk.com/llms.txt
file_size_bytes: 25174
link_count: 220
...
![Score 63/100 — Grade C](../../web/badge/docs.whisk.com.svg)
...
**File facts:** 24.6 KB · 2 `## sections` · 220 links (210 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 63 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/docs.whisk.com.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.whisk.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.whisk.com/llms.txt
```
