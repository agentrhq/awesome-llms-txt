---
domain: livecodes.io
display_name: LiveCodes
category: dev-tools
score: 74
grade: B
last_scored: 2026-05-27
verified_url: https://livecodes.io/llms.txt
file_size_bytes: 17852
link_count: 228
value_link_count: 228
section_count: 15
...
![Score 74/100 — Grade B](../../web/badge/livecodes.io.svg)
...
**File facts:** 17.4 KB · 15 `## sections` · 228 links (228 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 74 (B)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/livecodes.io.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/livecodes.io)
```

## Reproduce this score

```bash
npx llms-txt-score https://livecodes.io/llms.txt
```
