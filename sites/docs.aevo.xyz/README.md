---
domain: docs.aevo.xyz
display_name: Aevo Documentation
category: dev-tools
score: 61
grade: C
last_scored: 2026-05-27
verified_url: https://docs.aevo.xyz/llms.txt
file_size_bytes: 15772
link_count: 142
...
**H1:** Aevo Documentation


**File facts:** 15.4 KB · 1 `## sections` · 142 links (142 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.aevo.xyz/llms.txt
```
