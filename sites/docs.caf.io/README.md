---
domain: docs.caf.io
display_name: Certta DevHub
category: dev-tools
score: 68
grade: B
last_scored: 2026-05-27
verified_url: https://docs.caf.io/llms.txt
file_size_bytes: 61907
link_count: 503
value_link_count: 503
section_count: 4
...
![Score 68/100 — Grade B](../../web/badge/docs.caf.io.svg)
...
**File facts:** 60.5 KB · 4 `## sections` · 503 links (503 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 68 (B)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/docs.caf.io.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.caf.io)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.caf.io/llms.txt
```
