---
domain: naturelliving.com
display_name: Naturelliving
category: dev-tools
score: 45
grade: D
last_scored: 2026-05-27
verified_url: https://naturelliving.com/llms.txt
file_size_bytes: 13760
link_count: 100
...
![Score 45/100 — Grade D](../../web/badge/naturelliving.com.svg)
...
**H1:** https://naturelliving.com/ llms.txt


**File facts:** 13.4 KB · 0 `## sections` · 100 links (100 after low-value discount) · Freshness: 343 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 45 (D)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/naturelliving.com.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/naturelliving.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://naturelliving.com/llms.txt
```
