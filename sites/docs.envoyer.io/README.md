---
domain: docs.envoyer.io
display_name: Envoyer
category: dev-tools
score: 63
grade: C
last_scored: 2026-05-27
verified_url: https://docs.envoyer.io/llms.txt
...
![Score 63/100 — Grade C](../../web/badge/docs.envoyer.io.svg)
...
**File facts:** 1.2 KB · 2 `## sections` · 11 links (11 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 63 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/docs.envoyer.io.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.envoyer.io)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.envoyer.io/llms.txt
```
