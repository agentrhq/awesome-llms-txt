...
```markdown
[![llms.txt score 63 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/docs/badge/docs.envoyer.io.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.envoyer.io)
```
