---
domain: backmesh.com
display_name: Backmesh
category: ai-platform
score: 48
grade: D
last_scored: 2026-05-27
verified_url: https://backmesh.com/llms.txt
file_size_bytes: 628
link_count: 5
value_link_count: 4
section_count: 2
...
![Score 48/100 — Grade D](../../web/badge/backmesh.com.svg)
...
**File facts:** 0.6 KB · 2 `## sections` · 5 links (4 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 48 (D)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/backmesh.com.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/backmesh.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://backmesh.com/llms.txt
```
