---
domain: wordlift.io
display_name: WordLift
category: dev-tools
score: 45
grade: D
last_scored: 2026-05-27
verified_url: https://wordlift.io/llms.txt
file_size_bytes: 2881
link_count: 23
value_link_count: 19
section_count: 0
freshness_age_days: 547
---

# WordLift

![Score 45/100 — Grade D](../../web/badge/wordlift.io.svg)
...
**File facts:** 2.8 KB · 0 `## sections` · 23 links (19 after low-value discount) · Freshness: 547 days (per `Last-Modified`).
...
| Freshness | 1/10 | _stale_548_days_ |
| Discoverability | 8/8 | |
...
- Freshness (1/10): stale_548_days
- Auth signposting (0/8): no_auth_keywords, no_auth_section

## Embed the badge

```markdown
[![llms.txt score 45 (D)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/wordlift.io.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/wordlift.io)
```

## Reproduce this score

```bash
npx llms-txt-score https://wordlift.io/llms.txt
```
