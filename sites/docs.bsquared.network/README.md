...
![Score 55/100 — Grade C](../../web/badge/docs.bsquared.network.svg)
...
```markdown
[![llms.txt score 55 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/docs.bsquared.network.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.bsquared.network)
```
