...
```markdown
[![llms.txt score 55 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/docs/badge/docs.bsquared.network.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.bsquared.network)
```
