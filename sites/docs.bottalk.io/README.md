---
domain: docs.bottalk.io
display_name: BotTalk Docs
category: dev-tools
score: 56
grade: C
last_scored: 2026-05-27
verified_url: https://docs.bottalk.io/docs/llms.txt
file_size_bytes: 6344
link_count: 43
value_link_count: 43
section_count: 1
...
**File facts:** 6.2 KB · 1 `## sections` · 43 links (43 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.bottalk.io/docs/llms.txt
```
