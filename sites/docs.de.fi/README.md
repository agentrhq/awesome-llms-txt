---
domain: docs.de.fi
display_name: De Docs
category: dev-tools
score: 56
grade: C
last_scored: 2026-05-27
verified_url: https://docs.de.fi/llms.txt
file_size_bytes: 2029
link_count: 19
value_link_count: 19
section_count: 1
...
![Score 56/100 — Grade C](../../web/badge/docs.de.fi.svg)
...
```markdown
[![llms.txt score 56 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/docs.de.fi.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.de.fi)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.de.fi/llms.txt
```
