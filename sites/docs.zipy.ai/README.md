...
verified_url: https://docs.zipy.ai/llms.txt
file_size_bytes: 25876
link_count: 184
value_link_count: 184
section_count: 1
...
![Score 58/100 — Grade C](../../web/badge/docs.zipy.ai.svg)
...
**File facts:** 25.3 KB · 1 `## sections` · 184 links (184 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 58 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/web/badge/docs.zipy.ai.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.zipy.ai)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.zipy.ai/llms.txt
```
