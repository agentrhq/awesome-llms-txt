...
verified_url: https://www.x-cmd.com/llms.txt
file_size_bytes: 8260
link_count: 0
value_link_count: 0
section_count: 8
...
**File facts:** 8.1 KB · 8 `## sections` · 0 links (0 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
```bash
npx llms-txt-score https://www.x-cmd.com/llms.txt
```
