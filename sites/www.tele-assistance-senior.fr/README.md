---
domain: www.tele-assistance-senior.fr
display_name: Tele Assistance Senior
category: dev-tools
score: 27
grade: F
last_scored: 2026-05-27
verified_url: https://www.tele-assistance-senior.fr/llms.txt
file_size_bytes: 76083
link_count: 0
value_link_count: 0
section_count: 0
...
**File facts:** 74.3 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://www.tele-assistance-senior.fr/llms.txt
```
