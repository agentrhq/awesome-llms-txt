---
domain: www.incolintelligence.com
display_name: InCol Intelligence© (InCol Limited)
category: data
score: 52
grade: C
last_scored: 2026-05-27
verified_url: https://incolintelligence.com/llms.txt
file_size_bytes: 8250
link_count: 12
value_link_count: 12
section_count: 7
freshness_age_days: 99
---
...
**H1:** InCol Intelligence© (InCol Limited)

> AWS-hosted, plug-and-play SaaS for supervised mortgage analytics. Ingests and validates loan-level mortgage templates, consolidates proprietary loan data with third‑party/public datasets, and produces validated analytics and automated reporting across credit risk, collateral insi…

**File facts:** 8.1 KB · 7 `## sections` · 12 links (12 after low-value discount) · Freshness: 99 days (per `Last-Modified`).
...
```bash
npx llms-txt-score https://incolintelligence.com/llms.txt
```
