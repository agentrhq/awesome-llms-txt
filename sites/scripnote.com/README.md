---
domain: scripnote.com
display_name: Scripnote
category: dev-tools
score: 30
grade: F
last_scored: 2026-05-27
verified_url: https://scripnote.com/llms.txt
...
**File facts:** 1.6 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://scripnote.com/llms.txt
```
