---
domain: docs.junipercreates.com
display_name: Juniper Creates Guide
category: dev-tools
score: 56
grade: C
last_scored: 2026-05-27
verified_url: https://docs.junipercreates.com/llms.txt
file_size_bytes: 3058
link_count: 17
value_link_count: 17
section_count: 1
...
**H1:** Juniper Creates Guide


**File facts:** 3.0 KB · 1 `## sections` · 17 links (17 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.junipercreates.com/llms.txt
```
