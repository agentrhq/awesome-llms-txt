...
```markdown
[![llms.txt score 55 (C)](https://raw.githubusercontent.com/agentrhq/awesome-llms-txt/main/docs/badge/docs.adxcorp.kr.svg)](https://github.com/agentrhq/awesome-llms-txt/tree/main/sites/docs.adxcorp.kr)
```
